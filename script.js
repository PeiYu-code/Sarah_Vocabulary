...
const wordBank = [
  ...
  { eng: "bus", ch: "公車(n.)" },
  { eng: "desk", ch: "書桌(n.)" },
  { eng: "rain", ch: "雨水(n.)；下雨(v.)" },
  { eng: "next", ch: "下一個(adj.)" },
  { eng: "door", ch: "門(n.)" },
  { eng: "gate", ch: "大門、柵門(n.)" },
  { eng: "window", ch: "窗戶(n.)" },
  { eng: "cup", ch: "杯子(n.)" },
  { eng: "old", ch: "老的、舊的(adj.)" },
  { eng: "young", ch: "年輕的(adj.)" },
  { eng: "new", ch: "新的(adj.)" },
  { eng: "cute", ch: "可愛的(adj.)" },
  { eng: "hen", ch: "母雞(n.)" },
  { eng: "egg", ch: "蛋(n.)" },
  ...
  { eng: "television", ch: "電視(n.)" },
    ...
    { eng: "teach", ch: "教導(v.)" },
      { eng: "for", ch: "為了、因為" },
        ...
        { eng: "can", ch: "可以、能夠" },
        { eng: "time", ch: "時間、次數" },
        { eng: "take", ch: "拿、帶...去、搭乘(v.)" },
        { eng: "give", ch: "給(v.)" },
        { eng: "then", ch: "然後、那時" },
        { eng: "about", ch: "關於、大約" },
        { eng: "find", ch: "發現、找到(v.)" },
        { eng: "way", ch: "路、方法、方向、作風(n.)" },
        { eng: "even", ch: "甚至(adv.); 平均(adj.)" },
        { eng: "use", ch: "使用(v.)" },
        { eng: "useful", ch: "有用的(adj.)" },
        { eng: "think", ch: "思考、認為(v.)" },
        { eng: "own", ch: "自己的(adj.); 擁有(v.)" },
        { eng: "life", ch: "生活、生命(n.)" },
        { eng: "live", ch: "生活、居住(v.)" },
        { eng: "just", ch: "剛剛、只是(adv.)" },
        { eng: "between", ch: "在...(兩者)之間" },
        { eng: "still", ch: "仍然(adv.)" },
        { eng: "another", ch: "另一個(adj.)" },
        { eng: "work", ch: "工作、運作、有效(v.)" },
        { eng: "worker", ch: "工人、員工(n.)" },
        { eng: "coworker", ch: "同事(n.)" },
        { eng: "well", ch: "很好地(adv.); 健康的(adj.)" },
        { eng: "how", ch: "如何、多麼地" },
        { eng: "great", ch: "很棒的、很大的、偉大的(adj.)" },
        { eng: "thank", ch: "感謝(v., n.)" },
        { eng: "sorry", ch: "抱歉的、難過的(adj.)" },
        { eng: "all", ch: "全部的、整個(adj.)" },
        { eng: "become", ch: "變得、成為(v.)" },
        { eng: "tell", ch: "告訴(v.)" },
        { eng: "ask", ch: "詢問、要求(v.)" },
      { eng: "most", ch: "最、大多數的(adj.)" },
        { eng: "front", ch: "前面的(adj.)" },
        { eng: "in front of", ch: "在...前面" },
        { eng: "back", ch: "背面的(adj.)" },
        { eng: "in back of", ch: "在...後面" },
        { eng: "show", ch: "展示、給...看(v.)" },
        { eng: "housewife", ch: "家庭主婦(n.)" },
        { eng: "call", ch: "打電話、稱呼、叫(v.)" },
        { eng: "leave", ch: "離開、留下、使...處於某種狀態(v.)" },
      { eng: "school", ch: "學校(n.)" },
        { eng: "course", ch: "課程、過程(n.)" },
        { eng: "while", ch: "而、當、雖然" },
        { eng: "part", ch: "部分、角色、零件(n.)" },
        { eng: "end", ch: "末端、結尾(n.); 結束(v.)" },
        { eng: "start", ch: "開始(v.)" },
        { eng: "begin", ch: "開始(b開頭)" },
        { eng: "feel", ch: "覺得、感覺到(v.)" },
        { eng: "number", ch: "數字(n.)" },
        { eng: "follow", ch: "遵從、追蹤、順著(v.)" },
        { eng: "turn", ch: "轉向、轉變(v.)" },
        { eng: "problem", ch: "困難、問題(n.)" },
          { eng: "question", ch: "疑問(n.)" },
          { eng: "hold", ch: "握抓、舉辦(v.)" },
          { eng: "fact", ch: "事實(n.)" },
          { eng: "keep", ch: "保留、維持、養(寵物)(v.)" },
          { eng: "put", ch: "放置(v.)" },
          { eng: "bring", ch: "帶來(v.)" },
          { eng: "group", ch: "團體、群組(n.)" },
          { eng: "case", ch: "案件(n.)" },
          { eng: "point", ch: "點、重點(n.); 指向(v.)" },
          { eng: "line", ch: "線、隊伍(n.); 排成一列(v.)" },
          { eng: "area", ch: "地區、領域(n.)" },
          { eng: "let", ch: "讓(v.)" },
          { eng: "side", ch: "側面、側邊(n.)" },
          { eng: "try", ch: "嘗試(v.)" },
          { eng: "water", ch: "水(n.)" },
          { eng: "move", ch: "移動、搬家、感動(v.); 動作(n.)" },
          { eng: "movement", ch: "移動、社會運動(n.)" }
];
